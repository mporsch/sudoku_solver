...
struct custom_step_iterator : wrapped_iterator
{
  ...
  wrapped_iterator& operator+=(typename wrapped_iterator::difference_type n) noexcept {
    static_cast<wrapped_iterator&>(*this) += step * n;
    return *this;
  }

  wrapped_iterator operator+(typename wrapped_iterator::difference_type n) const noexcept {
...
template<typename wrapped_iterator>
custom_step_iterator<wrapped_iterator> make_custom_step_iterator(
  wrapped_iterator it,
  typename wrapped_iterator::difference_type step)
{
